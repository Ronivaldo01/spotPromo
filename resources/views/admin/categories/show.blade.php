...
@section('title', "Detalhes da categoria {$category->categorie}")

@section('content_header')
    <h1>
        Categoria: {{ $category->categorie }}
    </h1>
    ...
    <div class="content row">
        <div class="box box-success">
            <div class="box-body">
                ...
                <p><strong>Título: </strong>{{ $category->categorie }}</p>
                <p><strong>URL: </strong>{{ $category->status }}</p>
